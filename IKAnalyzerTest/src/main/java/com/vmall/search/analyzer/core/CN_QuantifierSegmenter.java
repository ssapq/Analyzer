...
import com.vmall.search.analyzer.dic.Hit;
...
class CN_QuantifierSegmenter implements ISegmenter{
	 ...
	 * 分词
	 */
	public void analyze(AnalyzeContext context,Dictionary dictionary) {
		//处理中文数词
		this.processCNumber(context);
		//处理中文量词
		this.processCount(context,dictionary);
	 ...
	 * @param context
	 */
	private void processCount(AnalyzeContext context,Dictionary dictionary){
		// 判断是否需要启动量词扫描
