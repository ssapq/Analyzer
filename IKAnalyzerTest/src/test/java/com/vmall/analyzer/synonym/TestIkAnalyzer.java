...
//            Directory directory = new RAMDirectory();
            ...
            DynmicDictinoaryLoader.getSingleton().doAddWord("动态加载词啊");
            this.index(analyzer,directory,document);
            this.search(directory,analyzer);
            ...
            DynmicDictinoaryLoader.getSingleton().doDeleteWord("动态加载词啊");
            this.index(analyzer,directory,document);
            this.search(directory,analyzer);
...
//        QueryParser parser = new QueryParser("content", analyzer);
        Term term = new Term("content", "动态加载词啊哦");
